...
const NEGATE_PATTERN = /違います|ちがいます|違う|ちがう|訂正|否定|間違って|まちがって|かけないで|掛けないで|止めて|やめて/;
...
const refreshCallerConfirmation = (toolState) => {
    ...
    for (const turn of afterValidation) {
        ...
        if (readbackSeen && phone.confirmed !== true && AFFIRM_PATTERN.test(text)) {
