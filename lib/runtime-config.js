...
export function sanitizeRuntimeConfig(config = {}) {
    ...
    return {
        models: {
            realtime: source.models?.realtime || source.REALTIME_MODEL || 'gpt-realtime-2.1-mini',
        ...
        voice: source.voice || source.VOICE || 'coral',
        vad: {
        ...
        callEnd: {
            ...
            markTimeoutMs: toNumber(source.callEnd?.markTimeoutMs ?? source.CALL_END_MARK_TIMEOUT_MS, 15000),
