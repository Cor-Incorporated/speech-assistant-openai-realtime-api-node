...
- ステータス: Wave 1 / 2A / 6 / 7 採用・実装完了 / Wave 2B は [ADR 0004](./0004-mvp-scope-2026-05.md) で範囲縮小 (PoC MVPサブセット) / Wave 3-5 はPoC対象外
...
>
> 下記「ロールアウト順序」では Wave 6 (Cloud Run基盤) と Wave 7 (050番号切替) を末尾に置いていますが、実体は2026-04時点でWave 1〜2Aと並行して完了しており、番号順=時系列順ではありません。
